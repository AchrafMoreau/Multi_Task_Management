...
return [
    ...
    "showMission" => "Afficher la Mission",
    "year" => "Filtré par Année",
    "month" => "Filtré par Mois",
    "manyMission" => "Nombre de missions",
    "manyEmetteur" => "Nombre d'émetteurs",
    "manyCourrier" => "Nombre de courriers",
    "manyDecharge" => "Nombre de décharges",
    "createdSuccess" => "Créé avec succès",
    "updatedSuccess" => "Mis à jour avec succès",
    "deletedSuccess" => "Supprimé avec succès",
    "saveAndDownload" => "Sauvegarder et Télécharger",
    ...
    "mission" => "Mission",
    "mission-list" => "Liste des missions",
    "somethingWrong" => "Une erreur s'est produite",
    "requiredField" => "Champs obligatoires",
    "region" => "Region",
    "statistic" => "Statistique",
    "showMail" => "Afficher le Courrier",
    "mail-list" => "Liste des Mails",
    "addMail" => "Ajouter un Mail",
    "addMailMessage" => "Veuillez remplir le formulaire pour ajouter un nouveau mail",
    "ENTRANT" => "ENTRANT",
    "SORTANT" => "SORTANT",
    "year" => 'Année',
    "all" => "Tout",
    "statistics" =>  "Statistiques",
    "pleaseSelectVille" => "Veuillez Sélectionner une Ville",
    "thosFieldRequired" => "Ces Champs sont Obligatoires",
    "add-expediteur" => "Ajouter un Expéditeur",
    "add-destination" => "Ajouter une Destination",
    "id" => "Identifiant",
    "reset" => "Réinitialiser",
    "themeSetting" => "Réglage du Thème",
    "welcomeBack" => "Bon retour",
    "SignintocontinuetoABH" => "Connectez-vous pour continuer vers le Maroc Meteo",
    ...
    "minPass" => "Le mot de passe doit comporter au moins 8 caractères",
    // ----------------- thired secion
    "edit" => "Update",
    ...
    "addDecharge" => "Ajouter une Décharge",
    "ville" => "City",
    "document" => "Document",
    "enter-nom" => "entrer un nom",
    "select-ville" => "sélectionnez une ville",
    "select-region" => "sélectionner une région",
    "editDecharge" => "Modifier la Décharge",
    "are-you-sure-message" => "Êtes-vous sûr de vouloir supprimer cet élément",
    "are-you-sure" => "Es-tu Sûr ?",
    "yes-delete-it" => "Oui Supprime",
    "etat" => "Etat",
    "zip" => "Code Postal",
    "addEmetteur" => "Ajouter un émetteur",
    "editEmetteur" => "Modifier Un émetteur",
    "emetteur-list" => "Liste des émetteurs",
    "welcome" => "Bonjour",
    //  --------seconde part

    "goodMorning" => "bonjour",
    "morningMessage" => "Voici ce qui se passe avec votre travail aujourd'hui.",
    "totalMails" => "Total des Courries",
    "viewTotalMails" => "voir tous les Courrires",
    "entrantCourrier" => "Courriers Entrants",
    "viewEntantCourrier" => "Voir Les Courriers Entrants",
    "sortantCourrier" => "Courriers Sortants",
    "entrantMail" => "Mails Sortants",
    "viewEntrantMail" => "Voir Les Mails Entrants",
    "sortantMail" => "Mails Sortant",
    "viewSortantMail" => "Voir Les Mails Sortant",
    "viewSortantCourrier" => "Voir Les Courriers Sortants",
    "totalDecharge" => "Total des Décharges",
    "viewTotalDecharge" => "Voir Toutes les Décharges",
    "dragAndDrop" => "Faites Glisser ou Déposez Votre Fichier Ici",
    "courrire-list" => "Liste de Courrières",
    "editCourrierMessage" => "remplissez tous les champs que vous souhaitez mettre à jour",
    "editCourrire" => "modifier le courrier",
    "showCourrire" => "détails du courrier",
    "nom" => "Nom",
    "adresse" => "Adresse",
    ...
    "zipCode" => "Code Postal",
    "close" => "Fermer",
    "addCourrierMessage" => "veuillez remplir le formulaire pour ajouter un nouveau courrier",
    "rh" => "Ressource Humains",
    "chooseDes" => "Sélectionnez une Destination",
    "chooseExp" => "Sélectionnez un Expéditeur",
    "action" => "Action",
    "documents" => "Documents",
    "addCourrier" => "Ajout un Courrier",
    "object" => "Object",
    "type" => "Type",
    "entrant" => "Entrant",
    "sortant" => "Sortant",
    ...
    "add-emetteur" => "Ajoute un Emetteur",
    "observation" => "Observation",
    "enter-observation" => "Tapez une Observation",
    "enter-object" => "Tapez un Object",
    "reception_jour" => "Jour de Reception",
    "reception-jour" => "Jour de Reception",
    "reception_time" => "Heure de Reception",
    "date" => "Date",
    "time" => "Temps",
    "submit" => "Soumetter",
    "submit" => "Soumetter",
